...
int main(void)
{
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  HAL_ADC_Start_DMA(&hadc1, (uint32_t *)adcResult, adcChennelCount);
	  while(!adcCheck){

	  }
	  adcCheck=0;
	  __HAL_TIM_SetCompare(&htim1, TIM_CHANNEL_1, adcResult[0]+adcResult[1]/8);
